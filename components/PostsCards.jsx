  ...
  return (
    <View className='flex-col items-center px-4 mb-14'>
        ...
        <View className='flex-row gap-3 items-start'>
            <View className='justify-center items-center flex-row flex-1'>
                <View className='w-[46px] h-[46px] rounded-lg border border-secondary justify-center items-center p-0.5'>
                    <Image source={items.author.profilePicture} resizeMode='cover' className='w-full h-full rounded-lg'/>
                </View>
        ...
        <View className='w-full h-60 rounded-xl border border-secondary-100 mt-3 justify-center items-center'>
            <Image source={items.image} className='w-full h-full mt-3 rounded-xl' resizeMode='cover'/>
        </View>
